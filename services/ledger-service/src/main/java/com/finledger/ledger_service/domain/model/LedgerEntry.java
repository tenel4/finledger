...
public final class LedgerEntry {
  ...
  public static LedgerEntry createNew(
    ...
    return new LedgerEntry(
        UUID.randomUUID(), Instant.now(), accountId, amount, referenceType, referenceId, messageId);
  }
  ...
  public static LedgerEntry rehydrate(
      ...
      UUID referenceId,
      UUID messageId) {
    return new LedgerEntry(id, entryTime, accountId, amount, referenceType, referenceId, messageId);
  }
  ...
  public SignedMoney amount() {
    return amount;
  }

  public LedgerEntryReferenceType referenceType() {
