...
class TradeControllerIT {
  ...
  @MockitoSpyBean private CreateTradeUseCase createTrade;
  @MockitoSpyBean private GetTradesUseCase getTrades;
  @MockitoSpyBean private GetSettlementsUseCase getSettlements;
  @MockitoSpyBean private RunEodReconciliationUseCase runEod;
  ...
  void createTrade_withInvalidBody_returns400() throws Exception {
    ...
    mockMvc
        .perform(post("/api/trades").contentType(MediaType.APPLICATION_JSON).content("{}"))
