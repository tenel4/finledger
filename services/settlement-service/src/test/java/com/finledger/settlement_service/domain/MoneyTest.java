...
class MoneyTest {
  ...
  void add_shouldReturnSum_whenCurrenciesMatch() {
    ...
    assertThat(result.amount())
        .isEqualByComparingTo(BigDecimal.valueOf(15).setScale(4, RoundingMode.HALF_UP));
  ...
  void subtract_shouldReturnDifference_whenCurrenciesMatch() {
    ...
    assertThat(result.amount())
        .isEqualByComparingTo(BigDecimal.valueOf(6).setScale(4, RoundingMode.HALF_UP));
    assertThat(result.currency()).isEqualTo(Currency.getInstance("USD"));
  }
  ...
  void times_shouldMultiplyAmount() {
    ...
    assertThat(result.amount())
        .isEqualByComparingTo(BigDecimal.valueOf(25).setScale(4, RoundingMode.HALF_UP));
    assertThat(result.currency()).isEqualTo(Currency.getInstance("USD"));
  }
