...
public class CreateTradeUseCaseImpl implements CreateTradeUseCase {
    ...
    public CreateTradeUseCaseImpl(TradeRepositoryPort tradeRepositoryPort, EventPublisher eventPublisher) {
    ...
    public Result execute(Command command) {
        ...
        log.info("Starting trade creation: symbol={} side={} quantity={} price={} currency={} correlationId={} traceId={}",
                command.symbol(), command.side(), command.quantity(), command.price(), command.currency(),
        ...
        Trade trade = Trade.createNew(
                command.symbol(), command.side(), quantity, price,
                command.buyerAccountId(), command.sellerAccountId());
        ...
        log.info("Trade created successfully: tradeId={} eventId={} correlationId={} traceId={}",
                trade.id(), domainEvent.eventId(), correlationId, traceId);
