...
public interface OutboxEventJpaRepository extends JpaRepository<OutboxEventEntity, UUID> {
  ...
  @Query(
      """
        ...
        """)
  Page<OutboxEventEntity> browse(
      @Param("status") OutboxStatus status, @Param("type") String type, Pageable pageable);
  ...
  @Query(
      """
        ...
        """)
  int updateStatus(
      @Param("id") UUID id, @Param("status") OutboxStatus status, @Param("now") Instant now);
}
