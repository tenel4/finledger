...
/**
 * Serialization-safe representation of a SettlementCreatedEvent for outbound messaging. Delegates
...
public record SettlementCreatedEventDto(
  ...
  public static SettlementCreatedEventDto fromDomain(SettlementCreatedEvent event) {
    ...
    String amountStr = event.netAmount().setScale(4, RoundingMode.HALF_UP).toPlainString();
