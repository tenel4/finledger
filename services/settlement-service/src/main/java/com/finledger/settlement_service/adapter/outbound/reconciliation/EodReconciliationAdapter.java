...
public class EodReconciliationAdapter implements EodReconciliationPort {
  ...
  public EodReconciliationAdapter(
      JdbcTemplate jdbc,
      ObjectMapper mapper,
  ...
  private List<Map<String, Object>> detectAnomalies(
      List<Map<String, Object>> trialBalance, List<Map<String, Object>> unsettled) {
  ...
  private void writeCsvReport(Path dir, List<Map<String, Object>> anomalies) throws IOException {
    ...
    try (CSVPrinter printer =
        new CSVPrinter(new OutputStreamWriter(Files.newOutputStream(csvFile)), CSV_FORMAT)) {
