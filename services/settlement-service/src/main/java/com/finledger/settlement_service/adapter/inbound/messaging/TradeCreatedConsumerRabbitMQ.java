...
public class TradeCreatedConsumerRabbitMQ {
    ...
    public void onMessage(String json,
        ...
        try {
            ...
            log.info("Received TradeCreatedEventDto message correlationId={} traceId={}", correlationId, traceId);

            TradeCreatedEventDto dto = mapper.readValue(json, TradeCreatedEventDto.class);

            useCase.execute(dto);

            log.info("Successfully processed TradeCreatedEventDto id={} correlationId={} traceId={}",
                    dto.eventId(), correlationId, traceId);

        } catch (JsonProcessingException e) {
            log.error("Failed to deserialize TradeCreatedEventDto, correlationId={}, payload={}", correlationId, json, e);
