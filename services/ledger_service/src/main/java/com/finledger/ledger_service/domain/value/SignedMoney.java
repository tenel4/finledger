...
public final class SignedMoney {
    ...
    private SignedMoney(BigDecimal amount, Currency currency) {
        this.amount = Objects.requireNonNull(amount, "SignedMoney: amount cannot be null")
    ...
    public boolean isDebit() { return amount.compareTo(BigDecimal.ZERO) < 0; }
    public boolean isCredit() { return amount.compareTo(BigDecimal.ZERO) > 0; }
