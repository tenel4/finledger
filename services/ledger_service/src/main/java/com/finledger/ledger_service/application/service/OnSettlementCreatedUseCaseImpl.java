...
public class OnSettlementCreatedUseCaseImpl implements OnSettlementCreatedUseCase {
  ...
  public OnSettlementCreatedUseCaseImpl(
      LedgerRepositoryPort ledgerRepo, ProcessedMessageRepositoryPort processedMessageRepository) {
