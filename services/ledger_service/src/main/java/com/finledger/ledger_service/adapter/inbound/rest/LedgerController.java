...
public class LedgerController {
  ...
  public LedgerController(
      GetLedgerEntriesUseCase getLedgerEntries, GetLedgerSummaryUseCase getSummary) {
  ...
  public ResponseEntity<List<LedgerEntryResponse>> getLedgerEntries(
      @RequestParam UUID accountId, @RequestParam LocalDate from, @RequestParam LocalDate to) {
