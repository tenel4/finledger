...
class GetLedgerSummaryUseCaseImplTest {
  ...
  void execute_shouldDelegateToRepositoryAndMapResults() {
    ...
    LedgerSummaryView view1 =
        new TestLedgerSummaryView(
            accountId1, Currency.getInstance("USD").toString(), BigDecimal.valueOf(100.25));
    LedgerSummaryView view2 =
        new TestLedgerSummaryView(
            accountId2, Currency.getInstance("EUR").toString(), BigDecimal.valueOf(-50.75));
